package com.techelecon.eda51scanner;
 ...
 */
public class Eda51scannerPlugin implements FlutterPlugin, MethodCallHandler, ScannerCallBack
{
    ...
    {
        new com.techelecon.eda51scanner.Eda51scannerPlugin().init(
                registrar.context(),
                registrar.messenger()
        );
    }

    public Eda51scannerPlugin() {
        handler = new Handler();
    }
